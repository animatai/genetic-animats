...
import animats.main
import animats.animat.genetic.genetic_example_7

parser = argparse.ArgumentParser()
parser.add_argument("config", help="animat configuration")
args = parser.parse_args()

(outputPath, outputDir) = animats.animat.genetic.genetic_example_7.getOutputPath()
animats.animat.genetic.genetic_example_7.run(args.config, outputPath, outputDir)
